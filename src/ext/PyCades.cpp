...
PyMODINIT_FUNC PyInit_pycades(void) {
    ...
    PyModule_AddIntConstant(module, "CAPICOM_CERT_INFO_SUBJECT_SIMPLE_NAME", 0);
    PyModule_AddIntConstant(module, "CAPICOM_CERTIFICATE_FIND_KEY_USAGE", 12);
    PyModule_AddIntConstant(module, "CRYPT_MODE_CBCSTRICT", 1);
    PyModule_AddIntConstant(module, "CRYPT_MODE_CNT", 3);
    PyModule_AddIntConstant(module, "CRYPT_MODE_CBCRFC4357", 31);
    PyModule_AddIntConstant(module, "CRYPT_MODE_CTR", 32);
    PyModule_AddIntConstant(module, "CRYPT_MODE_MGM", 33);
    PyModule_AddIntConstant(module, "CRYPT_MODE_GCM", 34);
    PyModule_AddIntConstant(module, "CRYPT_MODE_OMAC_CTR", 35);
    PyModule_AddIntConstant(module, "CRYPT_MODE_WRAP", 36);
    PyModule_AddIntConstant(module, "CRYPT_MODE_WRAP_PAD", 37);
    PyModule_AddIntConstant(module, "PKCS5_PADDING", 1);
    PyModule_AddIntConstant(module, "RANDOM_PADDING", 2);
    PyModule_AddIntConstant(module, "ZERO_PADDING", 3);
    PyModule_AddIntConstant(module, "ISO10126_PADDING", 4);
    PyModule_AddIntConstant(module, "ANSI_X923_PADDING", 5);
    PyModule_AddIntConstant(module, "TLS_1_0_PADDING", 6);
    PyModule_AddIntConstant(module, "ISO_IEC_7816_4_PADDING", 7);
